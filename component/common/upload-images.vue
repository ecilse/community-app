			...
			<view class="uni-uploader-body">
				<view class="uni-uploader__files">
					<block v-for="(image,index) in imageList" :key="index">
						<view class="uni-uploader__file position-relative rounded">
							<image class="uni-uploader__img rounded" :src="image" :data-src="image" @tap="previewImage" mode="aspectFill"></image>
							<view
							class="flex justify-center align-center position-absolute top-0 right-0 rounded"
							style="width: 60rpx;height: 60rpx;background-color: rgba(0, 0, 0, .5);"
